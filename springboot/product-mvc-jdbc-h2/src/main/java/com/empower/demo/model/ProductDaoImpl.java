...
public class ProductDaoImpl implements ProductDao {
	...
	public String createTables() {
		String sql="CREATE TABLE PRODUCT(ID NUMBER(5) PRIMARY KEY, NAME VARCHAR2(50) NOT NULL, CATEGORY VARCHAR2(20) NOT NULL, PRICE NUMBER(6,2))";
		jt.execute(sql);
		return "Product table is created.";
	}
